...
@interface HookMyApp : NSObject

@end

@implementation HookMyApp
...
CHConstructor // code block that runs immediately upon load
{
	@autoreleasepool
	{
		...
		// this would be posted using: notify_post("com.halou.HookMyApp.eventname");
		CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
		CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.halou.HookMyApp.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
